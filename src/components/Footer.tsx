        ...
        <div className="md:col-span-3 grid grid-cols-2 md:grid-cols-3 gap-4">
          <div>
            ...
            <ul className="space-y-1 text-sm">
              ...
              <li><Link to="#" className="hover:text-bee-amber transition-colors">Quiz Arena</Link></li>
              <li><Link to="#" className="hover:text-bee-amber transition-colors">Spaced Repetition</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm">
              ...
              <li><Link to="#" className="hover:text-bee-amber transition-colors">Blog</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm">
              ...
              <li><Link to="#" className="hover:text-bee-amber transition-colors">Contact</Link></li>
            </ul>
          </div>
        </div>
      </div>
